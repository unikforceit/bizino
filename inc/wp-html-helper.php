...
// image default alt
if (!function_exists('bizino_img_default_alt')) {
    function bizino_img_default_alt($url = '')
    {
...
// Image Tag
if (!function_exists('bizino_img_tag')) {
    function bizino_img_tag(array $args)
    {
        ...
        if (!empty($args['alt'])) {
            ...
            $alt = bizino_img_default_alt($url);
        }
...
// Anchor Tag
if (!function_exists('bizino_anchor_tag')) {
    function bizino_anchor_tag(array $args)
    {
...
// Heading Tag
if (!function_exists('bizino_heading_tag')) {
    function bizino_heading_tag(array $args)
    {
...
// Paragraph Tag
if (!function_exists('bizino_paragraph_tag')) {
    function bizino_paragraph_tag(array $args)
    {
...
// Other Tag
if (!function_exists('bizino_span_tag')) {
    function bizino_span_tag(array $args)
    {
