<?php
    ...
    Redux::setSection( $opt_name, array(
        'title'      => esc_html__( 'Woocommerce Page', 'bizino' ),
        'id'         => 'bizino_woo_page_page',
        'icon'  => 'el el-shopping-cart',
        'fields'     => array(
            array(
                'id'       => 'bizino_woo_shoppage_sidebar',
                'type'     => 'image_select',
                'title'    => esc_html__( 'Set Shop Page Sidebar.', 'bizino' ),
                'subtitle' => esc_html__( 'Choose shop page sidebar', 'bizino' ),
                //Must provide key => value(array:title|img) pairs for radio options
                'options'  => array(
                    '1' => array(
                        'alt' => esc_attr__('1 Column','bizino'),
            ...
            array(
                'id'       => 'bizino_woo_product_col',
                'type'     => 'image_select',
                'title'    => esc_html__( 'Product Column', 'bizino' ),
                'subtitle' => esc_html__( 'Set your woocommerce product column.', 'bizino' ),
                //Must provide key => value(array:title|img) pairs for radio options
                'options'  => array(
                    '2' => array(
                        'alt' => esc_attr__('2 Columns','bizino'),
                        'img' => esc_url( get_template_directory_uri() .'/assets/img/2col.png')
                    ),
                    '3' => array(
                        'alt' => esc_attr__('3 Columns','bizino'),
                        'img' => esc_url(  get_template_directory_uri() .'/assets/img/3col.png' )
                    ),
                    '4' => array(
                        'alt' => esc_attr__('4 Columns','bizino'),
                        'img' => esc_url( get_template_directory_uri(). '/assets/img/4col.png')
                    ),
                    '5' => array(
                        'alt' => esc_attr__('5 Columns','bizino'),
                        'img' => esc_url( get_template_directory_uri() .'/assets/img/5col.png')
                    ),
                    '6' => array(
                        'alt' => esc_attr__('6 Columns','bizino'),
			...
			array(
                'id'       => 'bizino_woo_product_perpage',
                'type'     => 'text',
                'title'    => esc_html__( 'Product Per Page', 'bizino' ),
				'default' => '10'
            ),
            array(
                'id'       => 'bizino_woo_singlepage_sidebar',
                'type'     => 'image_select',
                'title'    => esc_html__( 'Product Single Page sidebar', 'bizino' ),
                'subtitle' => esc_html__( 'Choose product single page sidebar.', 'bizino' ),
                //Must provide key => value(array:title|img) pairs for radio options
                'options'  => array(
                    '1' => array(
                        'alt' => esc_attr__('1 Column','bizino'),
            ...
            array(
                'id'       => 'bizino_product_details_title_position',
                'type'     => 'button_set',
                'default'  => 'below',
                'options'  => array(
                    'header'        => esc_html__('On Header','bizino'),
                ...
                'title'    => esc_html__('Product Details Title Position', 'bizino'),
                'subtitle' => esc_html__('Control product details title position from here.', 'bizino'),
            ),
            array(
                'id'       => 'bizino_product_details_custom_title',
                'type'     => 'text',
                'title'    => esc_html__( 'Product Details Title', 'bizino' ),
                'default'  => esc_html__( 'Shop Details', 'bizino' ),
                'required' => array('bizino_product_details_title_position','equals','below'),
            ),
            array(
                'id'       => 'bizino_product_details_custom_title',
                'type'     => 'text',
            ...
            array(
                'id'       => 'bizino_woo_relproduct_display',
                'type'     => 'switch',
                'title'    => esc_html__( 'Related product Hide/Show', 'bizino' ),
                'subtitle' => esc_html__( 'Hide / Show related product in single page (Default Settings Show)', 'bizino' ),
                'default'  => '1',
                'on'       => esc_html__('Show','bizino'),
                'off'      => esc_html__('Hide','bizino')
            ),
			array(
                'id'       => 'bizino_woo_relproduct_num',
                'type'     => 'text',
                'title'    => esc_html__( 'Related products number', 'bizino' ),
                'subtitle' => esc_html__( 'Set how many related products you want to show in single product page.', 'bizino' ),
                'default'  => 3,
                'required' => array('bizino_woo_relproduct_display','equals',true)
            ),

            array(
                'id'       => 'bizino_woo_related_product_col',
                'type'     => 'image_select',
                'title'    => esc_html__( 'Related Product Column', 'bizino' ),
                'subtitle' => esc_html__( 'Set your woocommerce related product column.', 'bizino' ),
                'required' => array('bizino_woo_relproduct_display','equals',true),
                //Must provide key => value(array:title|img) pairs for radio options
                'options'  => array(
                    '6' => array(
            ...
            array(
                'id'       => 'bizino_woo_upsellproduct_display',
                'type'     => 'switch',
                'title'    => esc_html__( 'Upsell product Hide/Show', 'bizino' ),
                'subtitle' => esc_html__( 'Hide / Show upsell product in single page (Default Settings Show)', 'bizino' ),
                'default'  => '1',
                'on'       => esc_html__('Show','bizino'),
                'off'      => esc_html__('Hide','bizino'),
            ),
            array(
                'id'       => 'bizino_woo_upsellproduct_num',
                'type'     => 'text',
                'title'    => esc_html__( 'Upsells products number', 'bizino' ),
                'subtitle' => esc_html__( 'Set how many upsells products you want to show in single product page.', 'bizino' ),
                'default'  => 3,
                'required' => array('bizino_woo_upsellproduct_display','equals',true),
            ),

            array(
                'id'       => 'bizino_woo_upsell_product_col',
                'type'     => 'image_select',
                'title'    => esc_html__( 'Upsells Product Column', 'bizino' ),
                'subtitle' => esc_html__( 'Set your woocommerce upsell product column.', 'bizino' ),
                'required' => array('bizino_woo_upsellproduct_display','equals',true),
                //Must provide key => value(array:title|img) pairs for radio options
                'options'  => array(
                    '6' => array(
            ...
            array(
                'id'       => 'bizino_woo_crosssellproduct_display',
                'type'     => 'switch',
                'title'    => esc_html__( 'Cross sell product Hide/Show', 'bizino' ),
                'subtitle' => esc_html__( 'Hide / Show cross sell product in single page (Default Settings Show)', 'bizino' ),
                'default'  => '1',
                'on'       => esc_html__( 'Show', 'bizino' ),
                'off'      => esc_html__( 'Hide', 'bizino' ),
            ),
            array(
                'id'       => 'bizino_woo_crosssellproduct_num',
                'type'     => 'text',
                'title'    => esc_html__( 'Cross sell products number', 'bizino' ),
                'subtitle' => esc_html__( 'Set how many cross sell products you want to show in single product page.', 'bizino' ),
                'default'  => 3,
                'required' => array('bizino_woo_crosssellproduct_display','equals',true),
            ),

            array(
                'id'       => 'bizino_woo_crosssell_product_col',
                'type'     => 'image_select',
                'title'    => esc_html__( 'Cross sell Product Column', 'bizino' ),
                'subtitle' => esc_html__( 'Set your woocommerce cross sell product column.', 'bizino' ),
                'required' => array( 'bizino_woo_crosssellproduct_display', 'equals', true ),
                //Must provide key => value(array:title|img) pairs for radio options
                'options'  => array(
                    '6' => array(
