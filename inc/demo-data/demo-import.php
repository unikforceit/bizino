...
function bizino_import_files() {
	...
	$demoImg = '<img src="'. BIZINO_DEMO_DIR_URI  .'screen-image.jpg" alt="'.esc_attr__('Demo Preview Imgae','bizino').'" />';
...
function bizino_after_import_setup() {
    ...
    if( class_exists( 'LS_Sliders' ) ){
		...
		new LS_ImportUtil( BIZINO_DEMO_DIR_PATH  . 'slider/Bizino-Slider-3.zip');
	}
