...
add_filter( 'loop_shop_per_page', 'bizino_new_loop_shop_per_page', 20 );
function bizino_new_loop_shop_per_page( $product_count ) {
  $product_count = bizino_opt( 'bizino_woo_product_perpage' );
...
add_filter('woocommerce_product_loop_start','bizino_woocommerce_product_loop_start');
function bizino_woocommerce_product_loop_start( ) {
    echo '<div class="row">';
}

// wooocommerce product loop start filter
add_filter('woocommerce_product_loop_end','bizino_woocommerce_product_loop_end');
function bizino_woocommerce_product_loop_end( ) {
    echo '</div>';
}

// woocommerce format sale price
add_filter('woocommerce_format_sale_price','bizino_woocommerce_format_sale_price',10,3);
function bizino_woocommerce_format_sale_price( $price, $regular_price, $sale_price ) {
...
add_filter('woocommerce_review_gravatar_size','bizino_woocommerce_review_gravatar_size');
function bizino_woocommerce_review_gravatar_size() {
    return 65;
}
...
add_filter('woocommerce_output_related_products_args','bizino_woocommerce_output_related_products_args',10,1);
function bizino_woocommerce_output_related_products_args( $args ) {
    if( class_exists('ReduxFramework') ) {
        $args['posts_per_page'] = bizino_opt('bizino_woo_relproduct_num');
    } else {
...
add_filter('woocommerce_upsell_display_args','bizino_woocommerce_upsell_display_args',10,1);
function bizino_woocommerce_upsell_display_args( $args ) {
    if( class_exists('ReduxFramework') ) {
        $args['posts_per_page'] = bizino_opt('bizino_woo_upsellproduct_num');
    } else {
        $args['posts_per_page'] = '3';
    }
    return $args;
...
function woocommerce_cross_sells_total( $limit ) {
    if( class_exists('ReduxFramework') ) {
        $limit = bizino_opt('bizino_woo_crosssellproduct_num');
    } else {
        $limit = '3';
    }
...
// Ajax Cart Count
add_filter( 'woocommerce_add_to_cart_fragments', 'bizino_refresh_mini_cart_count');
function bizino_refresh_mini_cart_count($fragments){
    ob_start();
    ?>
...
// Checkout fields
add_filter( 'woocommerce_checkout_fields' , 'bizino_override_checkout_fields' );
function bizino_override_checkout_fields( $fields  ){
    ...
    $fields['billing']['billing_first_name']['placeholder'] = esc_attr__('First Name', 'bizino');
    ...
    $fields['billing']['billing_email']['placeholder'] = esc_attr__('Email address', 'bizino');
    ...
    $fields['billing']['billing_city']['placeholder'] = esc_attr__('Town / City', 'bizino');
    ...
    $fields['billing']['billing_postcode']['placeholder'] = esc_attr__('Postcode', 'bizino');
    ...
    $fields['shipping']['shipping_first_name']['placeholder'] = esc_attr__('First Name', 'bizino');
    ...
    $fields['shipping']['shipping_last_name']['placeholder'] = esc_attr__('Last Name', 'bizino');
    ...
    $fields['shipping']['shipping_company']['placeholder'] = esc_attr__('Company name (optional)', 'bizino');
    ...
    $fields['shipping']['shipping_phone']['placeholder'] = esc_attr__('Phone', 'bizino');
    ...
    $fields['shipping']['shipping_email']['placeholder'] = esc_attr__('Email address', 'bizino');
    ...
    $fields['shipping']['shipping_city']['placeholder'] = esc_attr__('Town / City', 'bizino');
    ...
    $fields['shipping']['shipping_postcode']['placeholder'] = esc_attr__('Postcode', 'bizino');
...
add_filter( 'woocommerce_default_address_fields', 'bizino_override_default_locale_fields' );
function bizino_override_default_locale_fields( $fields ) {
...
add_filter( 'woocommerce_billing_fields' , 'bizino_custom_billing_fields' );
function bizino_custom_billing_fields( $fields ) {
    ...
    $fields['billing_first_name']['placeholder'] = esc_attr__('First Name', 'bizino');
    ...
    $fields['billing_last_name']['placeholder'] = esc_attr__('Last Name', 'bizino');
    ...
    $fields['billing_company']['placeholder'] = esc_attr__('Company name (optional)', 'bizino');
    ...
    $fields['billing_phone']['placeholder'] = esc_attr__('Phone', 'bizino');
    ...
    $fields['billing_email']['placeholder'] = esc_attr__('Email address', 'bizino');
    ...
    $fields['billing_city']['placeholder'] = esc_attr__('Town / City', 'bizino');
    ...
    $fields['billing_postcode']['placeholder'] = esc_attr__('Postcode', 'bizino');
...
add_filter( 'woocommerce_shipping_fields' , 'bizino_custom_shipping_fields' );
function bizino_custom_shipping_fields( $fields ) {

    // Shipping Fields

    $fields['shipping_first_name']['class'] = array('col-lg-6');
    $fields['shipping_first_name']['input_class'] = array('form-control');
    $fields['shipping_first_name']['placeholder'] = esc_attr__('First Name', 'bizino');
    ...
    $fields['shipping_last_name']['placeholder'] = esc_attr__('Last Name', 'bizino');
    ...
    $fields['shipping_company']['placeholder'] = esc_attr__('Company name (optional)', 'bizino');
    ...
    $fields['shipping_phone']['placeholder'] = esc_attr__('Phone', 'bizino');
    ...
    $fields['shipping_email']['placeholder'] = esc_attr__('Email address', 'bizino');
    ...
    $fields['shipping_city']['placeholder'] = esc_attr__('Town / City', 'bizino');
    ...
    $fields['shipping_postcode']['placeholder'] = esc_attr__('Postcode', 'bizino');
...
add_action('woocommerce_before_main_content','bizino_shop_col_start_cb');

// Shop column end wrapper hook
add_action('woocommerce_after_main_content','bizino_shop_col_end_cb',10);

// shop main content hook
add_action('bizino_shop_main_content','bizino_shop_main_content_cb',10);

// shop main content end hook
add_action('bizino_shop_main_content_end','bizino_shop_main_content_end_cb',10);

// bizino woocommerce pagination hook
add_action('woocommerce_after_shop_loop','bizino_woocommerce_pagination',10);

// bizino woocommerce filter wrapper hook
add_action('woocommerce_before_shop_loop','bizino_woocommerce_filter_wrapper',20);

// bizino woocommerce product content wrapper
add_action('bizino_woocommerce_product_content', 'bizino_woocommerce_tab_content_wrapper_start', 10 );
add_action('bizino_woocommerce_product_content', 'bizino_grid_tab_content_cb', 10 );
add_action('bizino_woocommerce_product_content', 'bizino_list_tab_content_cb', 20 );
add_action('bizino_woocommerce_product_content', 'bizino_woocommerce_tab_content_wrapper_end', 30 );

// bizino woocommerce get sidebar
add_action('woocommerce_sidebar','bizino_woocommerce_get_sidebar',10);

/*
*   Content Product Hook
*/

// bizino shop loop product thumbnail hook
add_action( 'woocommerce_before_shop_loop_item', 'bizino_loop_product_thumbnail', 10 );

// bizino shop loop hozrizontal product thumbnail hook
add_action( 'woocommerce_before_shop_horizontal_loop_item', 'bizino_loop_horiontal_product_thumbnail', 10 );

// bizino shop loop product summary hook
// add_action( 'woocommerce_after_shop_loop_item', 'bizino_loop_product_summary', 10 );

// bizino shop loop horizontal product summary hook
// add_action('woocommerce_after_shop_horizonal_loop_item', 'bizino_horizontal_loop_product_summary' );

// bizino shop loop horizontal product summary hook
add_action('bizino_woocommerce_shop_three_loop_product_summary','bizino_woocommerce_shop_three_loop_product_summary_cb',10);

/*
*   Single Product Hook
*/
// single product before summary
add_action('woocommerce_before_single_product_summary', 'bizino_woocommerce_before_single_product_summary',10);

// single product title
add_action('woocommerce_single_product_summary', 'bizino_woocommerce_single_product_title', 30 );

// single product price and rating
add_action('woocommerce_single_product_summary', 'bizino_woocommerce_single_product_price_rating', 20 );

// single product excerpt
add_action('woocommerce_single_product_summary', 'bizino_woocommerce_single_product_excerpt', 40 );

// single product availability
add_action( 'woocommerce_single_product_summary', 'bizino_woocommerce_single_product_availability', 50 );

// single product add to cart button
add_action('woocommerce_single_product_summary','bizino_woocommerce_single_add_to_cart_button',60);

// single product meta hook
add_action('woocommerce_single_product_summary','bizino_woocommerce_single_meta',80);

// single product sidebar
add_action('bizino_woocommerce_single_product_sidebar','bizino_woocommerce_single_product_sidebar_cb');

/*
* Single product quick view
*/
add_action('bizino_quickview_before_single_product_summary','bizino_woocommerce_before_single_product_summary',10);

// single product price and rating
add_action('bizino_quickview_single_product_summary','bizino_woocommerce_single_product_price_rating',20);

// single product title
add_action('bizino_quickview_single_product_summary','bizino_woocommerce_quickview_single_product_title',30);

// single product excerpt
add_action('bizino_quickview_single_product_summary','bizino_woocommerce_single_product_excerpt',40);

// single product add to cart button
add_action('bizino_quickview_single_product_summary','bizino_woocommerce_single_add_to_cart_button',60);
...
add_action('woocommerce_review_before_comment_meta','bizino_woocommerce_reviewer_meta',10,1);
...
add_action('woocommerce_proceed_to_checkout','bizino_woocommerce_button_proceed_to_checkout',20);

// cross sell products
add_action('woocommerce_after_cart','bizino_woocommerce_cross_sell_display',10);

// mini cart view cart button
add_action('woocommerce_widget_shopping_cart_buttons','bizino_minicart_view_cart_button',10);

// mini cart checkout button
add_action('woocommerce_widget_shopping_cart_buttons','bizino_minicart_checkout_button',20);

/*
*   checkout hook
*/

// bizino woocommerce checkout login form
add_action('woocommerce_before_checkout_form','bizino_woocommerce_before_checkout_form',10);
...
add_filter( 'wooscp_button_html', 'bizino_wooscp_button_html', 10, 2 );
function bizino_wooscp_button_html( $output , $prodid ) {
...
add_filter( 'wooscp_button_text_added', 'bizino_woo_compare_btn_text_added', 10, 2 );
function bizino_woo_compare_btn_text_added( ){
    return $output = '<i class="fal fa-layer-group"></i>';
}

add_filter( 'wooscp_button_text', 'bizino_compare_btn_text', 10, 2 );
function bizino_compare_btn_text(){
    return $output = '<i class="fal fa-layer-group"></i>';
}
...
add_filter( 'woosq_button_html', 'bizino_woosq_button_html', 10, 2 );
function bizino_woosq_button_html( $output , $prodid ) {
